...
from build_analyzer_v3 import XcodeBuildAnalyzer
from code_analyzer_v3 import CodeAnalyzer
from github_pr_v3 import GitHubPRClientV3
from review_models_v3 import FindingSource
from review_models_v3 import PRReviewResult
from review_models_v3 import Recommendation
from review_models_v3 import ReviewFinding
from review_models_v3 import Severity
from review_models_v3 import XcodeAnalysisResult
...
V3_SCRIPT_VERSION = "2026-08-18.2"
...
SUMMARY_MARKER = "pr-review-agent-v3-summary"
INLINE_MARKER_PREFIX = "pr-review-agent-v3-inline"
...
def list_pull_requests_for_selection(
    ...
    try:
        ...
        print(
            "Your local github_pr_v3.py does not support "
...
def format_inline_comment(
    ...
    return (
        ...
        f"**Why it matters:** {finding.why_it_matters}\n\n"
        f"**Suggested fix:** {finding.suggested_fix}\n\n"
        f"_Source: V3 {finding.source.value.lower()} analysis_"
    )
...
def ask_for_publish_approval() -> bool:
    print()
    print(
        "Human approval required before posting to GitHub."
    )
    print(
        "Type POST to publish inline and summary comments. "
...
def ask_for_duplicate_skip_confirmation(
    ...
    print(
        ...
        "comment(s) that V3 already posted on this PR."
    )
...
def find_duplicate_inline_findings(
    ...
    for finding in review.findings:
        ...
        if inline_comment_marker(finding) in existing_inline_markers:
...
def publish_review(
    ...
    for finding in review.findings:
        ...
        if marker in existing_inline_markers and skip_duplicates:
